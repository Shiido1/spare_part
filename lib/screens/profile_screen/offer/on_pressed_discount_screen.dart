...
class _OnPressedDiscountScreenState extends State<OnPressedDiscountScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<TopProductProvider>(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: TextViewWidget(
                                            ...
                                            text: widget.nameText==''?'':widget.nameText,
                                            fontWeight:FontWeight.w500,
                                            color: AppColor.black,textSize: 22,),
                                        ),
                                        Center(
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                            children: [
                                              TextViewWidget(
                                                text: widget.priceText==''?'':getNairaSign(context, widget.priceText),
                                        ...
                                        TextViewWidget(
                                          text: widget.categoryText==''?'':widget.categoryText,
                                          fontWeight:FontWeight.w500,
                        ...
                        Card(
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          GestureDetector(
                                            onTap:()=>setState(()=>onTap = true),
                                            child: TextViewWidget(
                                              text: 'Details',
                                              color: onTap==true?
                                              AppColor.black:AppColor.grey,
                                              textSize: 17,
                                            ),
                                          ),GestureDetector(
                                            onTap: ()=>setState(()=>onTap = false),
                                            child: TextViewWidget(
                                              text: 'Reviews (300)',
                                              color: onTap==true?
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: onTap==true?TextViewWidget(
                                  text: widget.descriptionText==null?'':widget.descriptionText,
                                  color: Colors.white,
                                  textSize: 17,
                                ):Padding(
                                  padding: const EdgeInsets.fromLTRB(16.0,35,16.0,35),
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      EditTextWidget(
                            ...
                            child: Row(
                              ...
                              children: [
                                TextViewWidget(
                                  ...
                                  fontWeight: FontWeight.bold,),
                                InkWell(
                                  onTap: ()=>cartProvider.add(items as ProductModel),
                                  child: Container(
                                    width: 150,
                                    height: 30,
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.all(Radius.circular(10)),
                                      color: cartProvider.isAdded==false?
                                      ...
                                      child: Row(
                                        children: [
                                          SvgPicture.asset(
                                            ...
                                            color: Colors.white,),
                                          TextViewWidget(
                                              text: cartProvider.isAdded==false?

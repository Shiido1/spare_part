...
class OrderScreenFeaturedProduct extends StatefulWidget {
  ...
  const OrderScreenFeaturedProduct({Key key, this.screenTitle}) : super(key: key);

  @override
  _OrderScreenFeaturedProductState createState() => _OrderScreenFeaturedProductState();
}

class _OrderScreenFeaturedProductState extends State<OrderScreenFeaturedProduct> {
  bool isOnTap=false;
  @override
  ...
  Widget orderItemContainer()=>Consumer<FeaturedProductProvider>(builder: (
